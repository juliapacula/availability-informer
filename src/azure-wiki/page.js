...
const BASE_URL = `https://dev.azure.com/${config.get('azure.organizationName')}/${config.get('azure.teamProjectName')}/_apis/wiki/wikis/${config.get('azure.wikiName')}/pages`;
...
module.exports = class Page {
    ...
    async create() {
        const template = new Page(`${config.get('azure.documentTemplatePath')}`);
        await template.get();
